...
function Destination() {
  ...
  let planetsImg = [Moon, Mars, Europa, Titan];
  ...
  return (
    <div className="destination content">
      ...
      <div className="container-destination padding-section">
        <section className="image-section">
          <div className="destination-world">
            <div className="destination-image">
              <img
                src={planetsImg[planetDestination]}
                alt={`planeta ${data.destinations[planetDestination].name}`}
              ></img>
            </div>
          </div>
          <div className="destination-selection">
            <ul>
              <li
                className={planetDestination === 0 ? "active" : ""}
                onClick={() => setPlanetDestination(0)}
              >
                Moon
              </li>
              <li
                className={planetDestination === 1 ? "active" : ""}
                onClick={() => setPlanetDestination(1)}
              >
                Mars
              </li>
              <li
                className={planetDestination === 2 ? "active" : ""}
                onClick={() => setPlanetDestination(2)}
              >
                Europa
              </li>
              <li
                className={planetDestination === 3 ? "active" : ""}
                onClick={() => setPlanetDestination(3)}
              >
                Titan
              </li>
            </ul>
        ...
        <section className="text-destination-section">
